...
Per interagire con gli studenti e per fornire il materiale didattico ed informazioni sul corso  verrà utilizzata la piattaforma Teams (utilizzare [questo link](https://teams.microsoft.com/l/team/19%3AFzzpmPtWFUnIZbPLpQkzgWqdWHJbTPV378RQiRg_O5g1%40thread.tacv2/conversations?groupId=3b646055-65ca-4eb9-aa6b-dbbfcf3e7035&tenantId=24c5be2a-d764-40c5-9975-82d08ae47d0e) per accedere).
...
-   Lunedì ore 11:30, aula 3;
-   Giovedì ore 08:30, aula B1;
...
Qualora uno studente conseguisse un voto >= 24 ad una delle due parti dell'esame ed un'insufficienza (>= 16) all'altra parte, il voto sufficiente verrà conservato fino all'appello successivo, indipendentemente che questo sia o meno nella stessa sessione d'esami.
